...
public class MainActivity extends AppCompatActivity {
    ...
    private void setTestData() {
        ...
        if (isFirstStart) {
            ...
            number.add("206966880000");
            name.add("a小红红");
            number.add("207977880001");
            name.add("a小蓝色");
            number.add("207977880001");
            name.add("ab小黄色");
            number.add("207977880022");
            name.add("aab小红黄");
            number.add("307977880000");
            name.add("bc大绿红");
            number.add("207777770000");
            name.add("ac大绿蓝");
            number.add("204944880006");
            name.add("c大蓝黄");
            number.add("202977880006");
            name.add("abc大蓝紫");
            number.add("207977880001");
            name.add("ca大紫色");
